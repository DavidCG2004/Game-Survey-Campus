...
![alt text](https://img.shields.io/badge/Angular-17+-DD0031?style=for-the-badge&logo=angular&logoColor=white)

![alt text](https://img.shields.io/badge/Ionic-7+-3880FF?style=for-the-badge&logo=ionic&logoColor=white)

![alt text](https://img.shields.io/badge/Supabase-BaaS-3ECF8E?style=for-the-badge&logo=supabase&logoColor=white)

![alt text](https://img.shields.io/badge/Capacitor-Hardware-119EFF?style=for-the-badge&logo=capacitor&logoColor=white)

![alt text](https://img.shields.io/badge/Firebase_Hosting-Dashboard-FFCA28?style=for-the-badge&logo=firebase&logoColor=black)
...
Cuenta en Supabase y API Key de RAWG
Pasos
...
Pon todo en el markdown, solo puedo copear esta parte lo quiero completo
Model 2:53 a.m.
ThinkingThoughts
Expand to view model thoughts

chevron_right
Aquí tienes el código completo en un solo bloque. Solo tienes que hacer clic en el botón de "Copiar código" (Copy code) en la esquina superior derecha del recuadro negro y pegarlo directamente en tu archivo README.md.
code
Markdown
# 🎮 Radar Gamer - Campus Survey App
...
Crea un archivo src/environments/environment.ts con tus credenciales:
code
TypeScript
...
Ejecutar en entorno de desarrollo (Web):
code
Bash
ionic serve
...
👨‍💻 Autores
[Tu Nombre / Tu Compañero] - Desarrollo Mobile, Arquitectura & UI/UX - Tu GitHub
Proyecto desarrollado para la asignatura de [Nombre de tu materia] - [Nombre de tu Universidad/Instituto], 2024.
